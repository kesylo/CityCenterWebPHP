                ...
                <div class="col-md-7 mx-auto">
                    <form action="<?php echo URLROOT; ?>/plannings/add" method="post">
                        ...
                        <div class="form-group">
                            ...
                            Semaine du :
                            <div class="input-group date" id="dateWeekAdd" data-target-input="nearest">
                                <input type="text" name="week" class="form-control datetimepicker-input"
                                       data-target="#dateWeekAdd" value="<?php echo $data['week']; ?>"
                                       onkeydown="return false;"
                                />
                                <div class="input-group-append" data-target="#dateWeekAdd" data-toggle="datetimepicker">
                            ...
                            Date :
                            <div class="input-group date" id="dateDayAvailableAdd" data-target-input="nearest">
                                <input type="text" name="date"
                                       class="form-control datetimepicker-input <?php echo (!empty($data['date_err'])) ? 'is-invalid' : ''; ?>"
                                       data-target="#dateDayAvailableAdd" value="<?php echo $data['date']; ?>"
                                       onkeydown="return false;"
                                />
                                <div class="input-group-append" data-target="#dateDayAvailableAdd" data-toggle="datetimepicker">
                                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                </div>
                            </div>
