...
<div class="row justify-content-center">
    ...
    <div class="mr-5">
        <div class="input-group date" id="weekDatePickerBulk" data-target-input="nearest">
            <input type="text" name="week" class="form-control datetimepicker-input" data-target="#weekDatePickerBulk" />
