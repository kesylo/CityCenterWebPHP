...
<div class="d-flex justify-content-center align-items-center container">
    <div class="row justify-content-center">
        ...
        <div class="col-7 col-md-8 col-lg-8">
            ...
            <a href="<?php echo URLROOT; ?>/plannings/add" class="btn btn-success fa-pull-right ml-md-2">
                <i class="fa fa-plus"></i> Ajouter une disponibilité
            </a>

            <a href="<?php echo URLROOT; ?>/plannings/addEffective" class="btn btn-warning fa-pull-right">
